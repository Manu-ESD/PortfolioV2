...
const ExperienceCard = () => {
  return (
    <div>
      <div className="h-[210px] w-[450px] border-2 rounded-md  bg-[#111117] border-[#0c0c10] flex flex-col justify-around items-left p-3 my-4 absolute overflow-hidden">
        <h1 className="text-[1.5rem] text-[#fff]">Frontend Developer</h1>
        <p className="text-[1rem] text-left text-[#fff]">
          From: 03/2021 -- Present
        </p>
        <p className="text-[0.7rem] text-justify text-[#fff] font-sans">
        ...
        <div className="h-[10vh] w-[10vh]  flex justify-center items-center  top-[-10%] right-[-25px] z-20 absolute">
