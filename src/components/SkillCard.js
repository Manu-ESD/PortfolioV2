...
const SkillCard = ({ SkillIcon, skillName }) => {
  ...
  return (
    <div>
      <div className="h-[100px] w-[100px] border-[1px] rounded-md bg-[#111117] border-[#0c0c10] flex justify-center items-center relative overflow-hidden hover:scale-105 z-50">
