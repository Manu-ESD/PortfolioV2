...
const SkillCard = ({ SkillIcon, skillName }) => {
  ...
  return (
    <div>
      <div className="h-[100px] w-[100px] border-[1px] rounded-md bg-[#111117] border-[#0c0c10] flex justify-center items-center relative overflow-hidden">
        <StyledICON></StyledICON>
        <div className="h-[10vh] w-[10vh]  flex justify-center items-center absolute top-[-25%] left-[-25px]">
      ...
      <p className="text-[0.75rem] text-center text-[#fff] mt-1 font-thin">
        {skillName}
      </p>
    </div>
  );
