...
const Nav = () => {
  ...
  return (
    <div className=" bg-[#25273400] border-[1px] border-[#ffffff] fixed h-[70px] w-[310px] sm:w-[510px] rounded-2xl sm:bottom-8 bottom-10 left-[calc(50%-155px)] sm:left-[calc(50%-253px)] flex items-center z-50">
